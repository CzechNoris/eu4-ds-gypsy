...
$python -m cProfile -o output/cprofiler -s cumtime ./scripts/gen_builds.py -b data/external/build_configs/_build_config.yaml --log-level INFO --exp-from 5 -i 7 -p 25
